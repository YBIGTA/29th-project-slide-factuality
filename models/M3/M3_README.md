...
|---|---|---|---|---|
| 13 | 0.2485 | 0.3036 | 0.6137 | 0.205~0.319 |
| 42 | 0.2578 | 0.3183 | 0.7220 | 0.205~0.375 |
| 777 | 0.3179 | 0.3316 | 0.6895 | 0.213~0.337 |

**test macro-F1 = 0.3178 ± 0.0115** (3 시드)
**generalization macro-F1 = 0.1979 ± 0.0420** (미지 분야 = 재무)
...
- 이 폴더의 가중치는 **dev macro-F1 최고 시드(seed 777, 0.3179)** 의 것이다.
...
- `results/M3_test.json` — 시드별 원시 결과
